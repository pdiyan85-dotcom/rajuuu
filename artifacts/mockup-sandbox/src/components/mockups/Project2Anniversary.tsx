...
const HARDCODED_DATA: BoxData = {
  ...
  noteText:
    "HEY! LOVE OF MY LIFE, THANK FOR COMING IN MY LIFE. WE COMPLETED 2 YEARS OF BEEN TOGETHER WITH LAUGHTER AND BEING TOGETHER INFINITE. 2 YEARS HAS BEEN PASSED LIKE 2 SECONDS. WITH YOU EVERY DAY FEELS LIKE EASIER. LOVE YOU THE MOST BACHUUUU.",
  closingText:
